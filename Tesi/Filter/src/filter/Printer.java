 ...
 * 
 * This class is Filter.jar main class. It filters an
 ...
 * 
 * It then implements the filtering algorithm. An InjectionHandler is
 ...
 * 
 * @throws IOException: Filter.jar, as default, is meant to be
 * launched from a fixed directory together with the file it filters. 
 * - If the file is not found in the same directory as Filter.jar:
 ...
 * as Filter.jar but there is no output file then a FileNotFoundException is triggered and
...
public class Printer {
	...
	public static final void main(String[] args) throws IOException {
		...
		case 0:
			...
			break;
		case 1:
			filter = new Filter("top-services-probes.txt", "injectableProbes//injectable-service-probes.txt", args[0]);
			break;
		case 3:
		...
		try {
			...
			try {
				...
				System.out.println(
						"Now filtering for payload \"" + (char) 27 + "[33m" + payload + (char) 27 + "[39m" + "\".");
				...
				System.out.println("Done. Stored results in " + filter.getOutputPath() + ".");
